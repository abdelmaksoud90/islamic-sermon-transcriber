...
- ✂️ تقسيم الصوت الطويل تلقائيًا إلى أجزاء عبر `fluent-ffmpeg` وإرسالها بالتوازي إلى **OpenAI Whisper** (`whisper-large-v3`).
...
- مفتاح **OpenAI API** يدعم نموذج `whisper-large-v3`.
